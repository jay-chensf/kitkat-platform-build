...
MKYAFFS2 := $(HOST_OUT_EXECUTABLES)/$(TARGET_AMLOGIC_MKYAFFSIMG_TOOL)
MKYAFFS2_ORIG := $(HOST_OUT_EXECUTABLES)/mkyaffs2image$(HOST_EXECUTABLE_SUFFIX)
else
...
# IMGPACK is always for the build OS, not for the host OS
IMGPACK := $(BUILD_OUT_EXECUTABLES)/imgpack$(BUILD_EXECUTABLE_SUFFIX)
